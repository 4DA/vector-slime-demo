...
/* 		gl_Position = perspectiveMatrix*or_pos[0];   */
/* 		EmitVertex();   */
/* 		gl_Position = perspectiveMatrix*or_pos[1];   */
/* 		EmitVertex();   */
/* 		gl_Position = perspectiveMatrix*or_pos[2];   */
...
/* 		gl_Position = perspectiveMatrix*v[0];   */
/* 		EmitVertex();   */
/* 		gl_Position = perspectiveMatrix*v[1];   */
/* 		EmitVertex();   */
/* 		gl_Position = perspectiveMatrix*v[2];   */
/* 		EmitVertex(); EndPrimitive();   */
/* 	}   */
...
/* 			gl_Position = perspectiveMatrix*v[2];   */
/* 			EmitVertex();   */
/* 			gl_Position = perspectiveMatrix*v[3];   */
/* 			EmitVertex(); EndPrimitive();   */
/* 		}   */
/* 	}   */
